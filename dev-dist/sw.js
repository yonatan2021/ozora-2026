...
define(['./workbox-34cc9331'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    request
  }) => ["script", "style", "font", "manifest"].includes(request.destination), new workbox.StaleWhileRevalidate({
