export const translations = {
  en: {
    ...
    footerInstallPrompt: "Haven't saved it offline yet?",
    footerInstallBtn: "Install now",
    footerInstallHelp: "On iPhone: tap Share, then Add to Home Screen.",
  ...
  he: {
    ...
    footerInstallPrompt: "עוד לא הורדת לאופליין?",
    footerInstallBtn: "הורד עכשיו",
    footerInstallHelp: "באייפון: לחצו Share ואז Add to Home Screen.",
    priorityMust: "חובה",
